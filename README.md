...
![System Architecture](snapshots/single/2.png)
...
### 📥 Step 1: Review Input
![Step 1](snapshots/single/3.review_section.png)

### 🏷️ Step 2: Named Entity Recognition (NER)
![Step 2](snapshots/single/4.Ner_Agent.png)

### 🧩 Step 3: Sentiment Quintuples
![Step 3](snapshots/single/5.quintuples.png)

### 🧠 Step 4: Coreference & Comparative Opinion Mining
![Step 4](snapshots/single/6.coref_comparitive.png)

### 📤 Step 5: Download Results
![Step 5](snapshots/single/7.Downloaded_Json.png)
...
### 🔼 Step 1: Upload CSV
![Step 1](snapshots/batch/1_batch.png)

### 👁️ Step 2: Preview Cleaned Reviews
![Step 2](snapshots/batch/2.Uploaded_Preview.png)

### 📝 Step 3: Annotations Summary per Review
![Step 3](snapshots/batch/6.batch_summary.png)

### 📈 Step 4: Generated Insights Summary
![Step 4](snapshots/batch/5.insights.png)
...
![Step 5](snapshots/batch/4.old_runs.png)

### 💾 Step 6: Download Processed CSVs
![Step 6](snapshots/batch/3.download_batch_processed.png)
